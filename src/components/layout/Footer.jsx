            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="border-t border-earth-800 pt-8 flex flex-col md:flex-row justify-between items-center text-sm text-earth-400">
                    ...
                    <div className="flex space-x-6 mt-4 md:mt-0">
                        {/* Instagram */}
                        <a href="#" className="flex items-center gap-2 hover:text-white transition" aria-label="Instagram">
                        ...
                        {/* Twitter */}
                        <a href="#" className="flex items-center gap-2 hover:text-white transition" aria-label="Twitter">
                            <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        {/* LinkedIn */}
                        <a href="#" className="flex items-center gap-2 hover:text-white transition" aria-label="LinkedIn">
                            <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
